...
function doQuiz (_level: number, _sprite: Sprite) {
    ...
    if (isMenu == true) {
        ...
        if (_sprite == NPC1) {
            ...
            NPC1 = sprites.create(assets.image`NovitaNPC`, SpriteKind.NPC)
            ...
            NPC2 = sprites.create(assets.image`EndangNPC`, SpriteKind.NPC)
...
function initGame () {
    ...
    info.setScore(0)
    info.startCountdown(listTime[isLevel - 1])
}
...
function doRiset () {
    sprites.destroyAllSpritesOfKind(SpriteKind.NPC, effects.spray, 100)
    sprites.destroyAllSpritesOfKind(SpriteKind.Player, effects.trail, 100)
    ...
    Dzakir = sprites.create(assets.image`Ngadini`, SpriteKind.Player)
...
info.onScore(70, function () {
    ...
    FinalNPC = sprites.create(assets.image`PradityaNPC`, SpriteKind.Food)
})
